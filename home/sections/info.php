  ...
  <div class="container">
    <div class="text-center">
      <div class="text-center">
        ...
        <br>
        <h6>
          Some lawncare companies dabble in aeration, <strong style="color: #523329;">but aeration is all we do.</strong> (with optional overseeding & fertilization). With our own commercial equipment and highly trained service techs, we are laser focused
          on delivering the results you expect.
        </h6>
        <a class="btn btn-default btn-md" href="about-us.php">Lean More About Us</a>
      </div>
      <br><br>
      <div style="border: 5px solid brown;padding:10px;">
        <h3 style="color: #f3b143; text-shadow: 2px 2px #041103;">SPECIAL: $95 to Core Aerate your ¼ Acre Lawn!</h3>
        <br>
      ...
      <br><br>
      <h4>
        Aeration is a very seasonal process. <br>With our current demand, we may only be in your area one time this season. <br> Reserve your spot today to ensure your lawn receives our premium service.
      </h4>
