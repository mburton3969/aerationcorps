...
<body>
    ...
    <div class="wrapper theme-4-active pimary-color-red">
        ...
        switch($r['lot_size']) {
            case '1':
              $ls = $quarter;
              if((int)$zlls >= $ls){echo '<a href="' . $zillowURL . '" target="_blank"><i class="zmdi zmdi-flag" style="color:red;font-size:24px;font-weight:bold;text-align:center;"></i></a>';}else{echo '<i class="zmdi zmdi-check" style="color:green;font-size:24px;font-weight:bold;text-align:center;"></i>';}
              break;
            case '2':
              $ls = $third;
              if((int)$zlls >= $ls){echo '<a href="' . $zillowURL . '" target="_blank"><i class="zmdi zmdi-flag" style="color:red;font-size:24px;font-weight:bold;text-align:center;"></i></a>';}else{echo '<i class="zmdi zmdi-check" style="color:green;font-size:24px;font-weight:bold;text-align:center;"></i>';}
