			...
			<div class="mobile-only-brand pull-left">
				<div class="nav-header pull-left">
					<div class="logo-wrap">
						<a href="index.php">
							<?php
                  				echo '<img class="brand-img" alt="brand" src="http://' . $_SERVER['HTTP_HOST'] . '/assets/img/white-mf-logo.png" style="width:80%;">';
                  			?>
						</a>
					</div>
				</div>	
				<a id="toggle_nav_btn" class="toggle-left-nav-btn inline-block ml-20 mt-20 pull-left" href="javascript:void(0);"><i class="zmdi zmdi-menu"></i></a>
				...
				<ul class="nav navbar-right top-nav pull-right">
					...
					<li class="dropdown auth-drp">
						...
						<ul class="dropdown-menu user-auth-dropdown" data-dropdown-in="flipInX" data-dropdown-out="flipOutX">
							<li>
								<a href="profile.html"><i class="zmdi zmdi-accounts"></i><span>Manage Users</span></a>
							</li>
							<li>
								<a href="#"><i class="zmdi zmdi-settings"></i><span>My Account</span></a>
							</li>
							<li>
								<a href="inbox.html"><i class="zmdi zmdi-graduation-cap"></i><span>Knowledge Base</span></a>
							</li>
							<li>
								<a href="#"><i class="zmdi zmdi-labels"></i><span>Print Labels</span></a>
							</li>
							<!--<li class="divider"></li>
