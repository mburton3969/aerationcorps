								...
								<div class="panel-body row pa-0">
									<div class="table-wrap">
										<div class="table-responsive">
											<table id="deleted_table" class="table table-hover mb-0">
												<thead>
													<tr>
														<th>ID</th>
														<th>Last</th>
              ...
              $lot_size = 'LOT SIZE ERROR!!!!';
                              ...
                              echo '</span></td>';
                                   ...
                                   echo '<td>
                                      ...
                                      <button type="button" class="btn btn-success btn-sm" onclick="restore_customer(' . $r['ID'] . ',this);"><i class="fas fa-trash-restore"></i> Restore</button>
                                    </td>
                                  </tr>';
                          }
													?>
